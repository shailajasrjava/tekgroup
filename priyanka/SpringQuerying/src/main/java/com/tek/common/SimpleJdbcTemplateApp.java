...
public class SimpleJdbcTemplateApp 
{
    public static void main( String[] args )
    {
        ...
        Customer customer1 = new Customer(1, "tek1",21);
        Customer customer3 = new Customer(2, "tek2",22);
        Customer customer2 = new Customer(3, "tek3",23);
        ...
        Customer customer4 = new Customer(4, "tek4",24);
        Customer customer5 = new Customer(5, "tek5",25);
        Customer customer6 = new Customer(6, "tek6",26);
