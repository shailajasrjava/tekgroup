package com.tek.customer.dao.impl;
...
import com.tek.customer.model.CustomerRowMapper;
	...
	public void insertBatch(final List<Customer> customers){
		...
		getJdbcTemplate().batchUpdate(sql, new BatchPreparedStatementSetter() {
			...
			public void setValues(PreparedStatement ps, int i) throws SQLException {
				...
				ps.setLong(1, (Long) customer.getCustId());
				ps.setString(2, (String) customer.getName());
				ps.setInt(3, (Integer) customer.getAge() );
			}
